    ...
    pattern_sites={"createsend":"https://www.zendesk.com/",
     ...
     pattern_response=["<strong>Trying to access your account",
      ...
      begin
        ...
        tmp_ip = ip
        print_state(i,max.to_i,"Ping #{sub.to_s}.#{@raven_target_domain}")
        ...
        begin # Sub domain takeover check
          print_state(i,max.to_i,"Check CNAME #{sub.to_s}.#{@raven_target_domain}")
          ...
          print_state(i,max.to_i,"Check Site, TAKEOVER - #{sub.to_s}.#{@raven_target_domain}")
